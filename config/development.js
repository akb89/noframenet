...
const development = {
    ...
    validLayers: ['FE', 'PT', 'GF'], // Configured this way for scalability, as other
    // languages may use additional specific layers
    // validLayers: ['FE', 'PT', 'GF', 'Target', 'PENN', 'NER', 'WSL', 'Other', 'Sent', 'Noun']
